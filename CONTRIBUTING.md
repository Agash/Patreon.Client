# Contributing to Patreon.Client
...
```bash
dotnet restore Patreon.Client.slnx
dotnet build Patreon.Client.slnx
dotnet test Patreon.Client.slnx
```
...
```bash
dotnet test Patreon.Client.slnx --filter "TestCategory!=Integration"
```
